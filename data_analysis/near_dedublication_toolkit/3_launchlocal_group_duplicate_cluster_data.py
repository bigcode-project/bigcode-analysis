...
def run():
    ...
    for i in range(len(langs)-1, -1, -1):
        ...
        command = f'make {script}.launch-slim-nowait SCRIPT_ARGS="{lang}" MORE_JOB_ARGS="--mem {mem} --cpu 8 --data snow.code_llm.data:/data --data snow.text_to_sql.transformers_cache:/transformers_cache"'
